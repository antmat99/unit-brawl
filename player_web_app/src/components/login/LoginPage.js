...
function LoginPage(props) {
    ...
    return (
        <Container fluid className='center-vertically'>
            ...
            <Row className='justify-content-md-center'>
                <Col lg='auto' className='center-horizontally'>
                    <Form noValidate validated={validated} onSubmit={handleSubmit} >
                        ...
                        <Form.Group controlId="validationCustomUsername" className='margin-bottom-1'>
                        ...
                        <Button type="submit" className='margin-bottom-1'> Login </Button>
                    </Form>
                </Col>
            </Row>
            <Row className='justify-content-md-center'>
